		...
		<div class="services">
			...
			<div class="w3ls_service_grids">
				...
				<div class="col-md-7 w3ls_service_grid_right">
					<div class="col-md-4 w3ls_service_grid_right_1">
						<img src="laravel/public/images/18.jpg" alt=" " class="img-responsive" />
					</div>
					<div class="col-md-4 w3ls_service_grid_right_1">
						<img src="laravel/public/images/19.jpg" alt=" " class="img-responsive" />
					</div>
					<div class="col-md-4 w3ls_service_grid_right_1">
						<img src="laravel/public/images/20.jpg" alt=" " class="img-responsive" />
					</div>
			...
			<div class="w3ls_service_grids1">
				<div class="col-md-6 w3ls_service_grids1_left">
					<img src="laravel/public/images/4.jpg" alt=" " class="img-responsive" />
				</div>
	...
	<div class="services-bottom">
		<div class="container">
			...
			<!-- Stats-Number-Scroller-Animation-JavaScript -->
				<script src="laravel/public/js/waypoints.min.js"></script> 
				<script src="laravel/public/js/counterup.min.js"></script> 
				<script>
