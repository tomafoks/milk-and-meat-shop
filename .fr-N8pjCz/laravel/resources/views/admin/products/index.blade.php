                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div class="icheck-primary d-inline">
                                                <input type="checkbox" id="checkboxPrimary3" disabled name="hit" @if ($product->hit == 1) checked @endif>
                                        ...
                                        <div class="form-group">
                                            <div class="icheck-danger d-inline">
                                                <input type="checkbox" id="checkboxDanger3" disabled name="new" @if ($product->new == 1) checked @endif>
                                        ...
                                        <div class="form-group">
                                            <div class="icheck-success d-inline">
                                                <input type="checkbox" id="checkboxSuccess2" disabled name="recommend" @if ($product->recommend == 1) checked @endif>
