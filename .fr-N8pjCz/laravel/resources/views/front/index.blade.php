...
@section('content')
    ...
    <div class="w3l_banner_nav_right">
        ...
        <!-- flexSlider -->
        <link rel="stylesheet" href="{{asset('laravel/public/css/flexslider.css') }}" type="text/css" media="screen"
            property="" />
        <script defer src="{{asset('laravel/public/js/jquery.flexslider.js') }}"></script>
